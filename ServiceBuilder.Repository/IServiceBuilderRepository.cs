...
{
    public interface I%SERVICEBUILDER%Repository : IDisposable
    {
        ...
        IQueryable<T> SelectByPartialText<T>(string text) where T : class;
        ...
        /// <summary>
        /// Undo any changes that have not been saved to the database.
        /// </summary>
        void UndoChanges();
    }
